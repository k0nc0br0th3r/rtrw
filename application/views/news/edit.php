            ...
            <div class="portlet light portlet-fit portlet-form bordered">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-red sbold uppercase">Sunting Berita </span>
                    </div>
                    <div class="actions">
                        <a class="btn btn-default ajaxify news-back" href="<?php echo site_url('news'); ?>">
                ...
                <div class="portlet-body">
                    <!-- BEGIN FORM-->
                    <form id="form" method="post" action="<?php echo site_url('news/save'); ?>" class="form-horizontal form-bordered news-form" enctype="multipart/form-data">
                        ...
                        <div class="form-body">
                            ...
                            <!-- jika gambar ada -->
                            <?php 
                                $link = dir_upload('uploads/news/', 'link'); 
                                $path = dir_upload('uploads/news/', 'path'); 
