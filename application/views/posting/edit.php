            ...
            <div class="portlet light portlet-fit portlet-form bordered">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-red sbold uppercase">Form edit <?php echo $ktg[$this->uri->segment(4)] ?></span>
                    </div>
                    <div class="actions">
                ...
                <div class="portlet-body">
                    ...
                    <!-- BEGIN FORM-->
                    <form id="form" method="post" action="<?php echo site_url('posting/edit/'.$this->uri->segment(4).'/'.$this->uri->segment(5)) ?>" class="form-horizontal form-bordered">
                        <div class="form-body">
                            ...
                            <div class="form-group form-md-line-input">
                                ...
                                <div class="col-md-9">
                                    <textarea class="form-control" name="deskripsi" id="deskripsi" rows="6"><?php echo $rowdat->deskripsi ?></textarea>
                            ...
                            <div class="form-group form-md-line-input">
                                ...
                                <div class="col-md-9">
                                    ...
                                    foreach ($tp as $k => $l) {
                                        # code...
                                        if($rowdat->tipe==$k) { $sek = "selected"; } else { $sek = ""; }
                            ...
                            <div class="form-group form-md-line-input">
                                ...
                                <div class="col-md-9">
                                    ...
                                    foreach ($st as $s => $sl) {
                                        # code...
                                        if($rowdat->status==$s) { $sek2 = "selected"; } else { $sek2 = ""; }
                                        echo '<option value="'.$s.'" '.$sek2.'>'.$sl.'</option>';
                                    }
                                    ?>
                                    </select>
                                    <div class="form-control-focus"> </div>
