...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>SI RTRW | Desa Tanimulya</title>
    ...
    <body class="page-container-bg-solid page-header-fixed page-sidebar-closed-hide-logo">
            ...
            <div class="page-sidebar-wrapper">
                ...
                <div class="page-sidebar navbar-collapse collapse">
                    ...
                    <ul class="page-sidebar-menu" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
                        ...
                        <li class="heading">
                            <h3 class="uppercase">Profil Desa</h3>
                        </li>
                        <li class="nav-item">
                            <a href="<?php echo base_url() ?>" class="nav-link">
                                <i class="icon-diamond"></i>
                                <span class="title">Sekilas Desa</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?php echo base_url() ?>" class="nav-link">
                                <i class="icon-diamond"></i>
                                <span class="title">Visi dan Misi</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?php echo base_url() ?>" class="nav-link">
        ...
        <div class="page-footer">
            <div class="page-footer-inner"> 2017 &copy; Desa Tanimulya. Program by
                <a target="_blank" title="Program by" href="#">ImamTeguh</a> &nbsp;|&nbsp;
                <a href="#" title="Theme Metronic" target="_blank">Theme Metronic</a>
            </div>
